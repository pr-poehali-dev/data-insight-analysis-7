    ...
    <footer className="bg-foreground text-background py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold">Нейроконтент Про</span>
            </div>
            <p className="text-sm text-background/70">Закрытый канал с обучением по созданию нейроконтента с помощью нейросетей.</p>
          </div>
          <div>
        ...
        <div className="border-t border-background/20 pt-8 text-center text-sm text-background/70">
          <p>&copy; 2026 Нейроконтент Про. Все права защищены.</p>
        </div>
      </div>
    </footer>
  )
